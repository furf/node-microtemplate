...
function MicroTemplate (method, templateName, templateDir, rendererDir) {
...
MicroTemplate.prototype = {

  /**
   * Returns current rendered state (true if renderer file exists)
   *
   * @see MicroTemplateBundle used to determine if cached bundle is still valid
   *
